      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.slice(0, 3).map((service) => (
            <motion.div
              key={service.title}
              className="service-card group relative bg-[#111111] border border-white/10 rounded-xl p-8 transition-colors duration-300 hover:border-brand-gold/60 flex flex-col"
              whileHover={{
                y: -8,
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 lg:gap-8 mt-6 lg:mt-8">
          {services.slice(3).map((service) => (
            <motion.div
              key={service.title}
              className="service-card group relative bg-[#111111] border border-white/10 rounded-xl p-8 transition-colors duration-300 hover:border-brand-gold/60 flex flex-col md:w-[calc(33.333%-1rem)]"
              whileHover={{
                y: -8,
                boxShadow: "0 20px 40px rgba(201, 168, 76, 0.1)",
              }}
